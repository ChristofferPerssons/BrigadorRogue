...
* Brigador Rogue creates a dll which itself injects some assembly patches into brigador's execution. All interesting logic come from BrigadorRogue.cpp
